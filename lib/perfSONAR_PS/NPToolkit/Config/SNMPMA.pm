package perfSONAR_PS::NPToolkit::Config::SNMPMA;
...
perfSONAR_PS::NPToolkit::Config::SNMPMA

=head1 DESCRIPTION

Module for reading/writing commonly configured aspects of the SNMP MA.
...
my %defaults = (
    config_file  => "/opt/perfsonar_ps/snmp_ma/etc/daemon.conf",
