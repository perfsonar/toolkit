package perfSONAR_PS::NPToolkit::Config::TracerouteMA;
...
perfSONAR_PS::NPToolkit::Config::TracerouteMA

=head1 DESCRIPTION

Module for reading/writing commonly configured aspects of the Traceroute MA.
...
my %defaults = (
    config_file  => "/opt/perfsonar_ps/traceroute_ma/etc/daemon.conf",
