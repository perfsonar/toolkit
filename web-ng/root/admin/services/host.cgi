...
my $internal_addresses_method = perfSONAR_PS::NPToolkit::WebService::Method->new(
...
$internal_addresses_method->add_input_parameter(
...
$router->add_method($internal_addresses_method);
